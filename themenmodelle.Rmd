...
Wie wenden LSA folgend auf das Facebook-Korpus an, um den Unterschied zwischen Kommentaren auf rechtspopulistischen Seiten und Nachrichtenseite näher zu untersuchen. Zunächst laden wir die Daten, ziehen ein kleineres Zufallssample, berechnen eine DFM und wenden dann die eigentliche LSA (mittels [textmodel_lsa](https://quanteda.io/reference/textmodel_lsa.html)) an. 
...
Nun können wir die 10 Dimensionen der LSA, für welche wir den Vergleich gerechnet haben, untereinander vergleichen, und zwar unter Rückgriff auf die Unterscheidung zwischen  Rechtspopulismus/Nachrichten. 
